-- Aplicar en Supabase SQL Editor (proyecto CRM.LITE) después de 0010.
-- Contenido equivalente a supabase/migrations/0011_n8n_writeback.sql
-- (ya aplicada vía MCP el 2026-07-09; este archivo queda como referencia).

-- El secreto de integración es el mismo n8n_webhook_secret cargado en 0010.
-- Si hiciera falta rotarlo:
-- insert into private.integration_secrets (key, secret_value)
-- values ('n8n_webhook_secret', '<tu-secreto>')
