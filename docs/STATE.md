...
_Última actualización: 2026-07-10 (gestión de roles desde Equipo mergeada + UXR-1/UXR-2 implementados: error de login OAuth visible + fix del logo de respaldo)_
