...
- **Identidad visual**: antes de tocar UI o gráficos, leer `docs/IDENTIDAD-VISUAL.md` y el manual del repositorio hermano `C:\Project\Project\crm-hunter-leads-brand`.
