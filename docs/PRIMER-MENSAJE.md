...
## Fase 1 — Que el cliente recuerde de dónde salió

Migración chica:

- `clients.prospect_id uuid references public.prospects(id) on delete set null`.
- `promote_prospects` lo completa al insertar.
...
## Fase 2 — Qué vendemos (decisión del usuario: varias ofertas)
...
## Fase 3 — El mensaje en la ficha del cliente
...
## Fase 4 — Que quede en el historial
...
## Fase 5 — El segundo mensaje, que es el difícil
